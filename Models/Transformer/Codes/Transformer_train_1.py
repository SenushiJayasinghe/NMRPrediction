...
log):
  ...
  - The source code also claims "patience of 25" in the paper text, but
    ...
    human hit Ctrl+C). Early stopping implemented and stop a fold.
...
# ---- Transformer architecture (faithful to the source paper) ----
...
class NMRTransformer(nn.Module):
    ...
    No positional encoding (bin order already encodes chemical-shift order).
