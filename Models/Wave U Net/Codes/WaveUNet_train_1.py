...
NUM_LAYERS           = 6     # down/up levels (paper used up to 12, for much longer audio clips)
NUM_INITIAL_FILTERS  = 24    # paper default; channel count grows LINEARLY as num_initial_filters*(i+1)
FILTER_SIZE          = 15    # down-path conv kernel (paper default)
MERGE_FILTER_SIZE    = 5     # skip-concat conv kernel (paper default)
OUTPUT_FILTER_SIZE   = 1     # final output conv kernel
LEAKY_RELU_SLOPE     = 0.2

# ---- GroupNorm (NEW -- not in the source, see module docstring) ----
GROUP_NORM_GROUPS = 8
