...
NEW IN THIS VERSION:
  ...
  6. FULL PEAK / MULTIPLICITY EVALUATION PIPELINE (new): implements the
     ...
     confusion matrix. Five CSV outputs are produced (see bottom of file).
...
# ---- GroupNorm (NEW -- replaces BatchNorm1d) ----
...
#     Redesigned: two SEPARATE stacked plots per compound (top=Simulated,
#     bottom=Predicted) instead of an overlay. "Actual" renamed "Simulated"
#     throughout.
# ============================================================================
